...
export default function Landing() {
  ...
  useGSAP(() => {
    ...
    master.addLabel("problem")
        .to(".stylized-orb", { opacity: 0, scale: 0.5, duration: 1 }, 2)
        .to(".map-wrapper", { opacity: 0.6, scale: 1, duration: 1.5 }, 2)
  ...
  }, { scope: container, dependencies: [showOverlay] });

  return (
    <div ref={container} className="landing-root">
      {/* Background System */}
      ...
      {/* Login Overlay */}
      <section className={`login-overlay ${!showOverlay ? 'slide-up hidden' : ''}`} role="dialog">
          ...
          <div className="login-content">
              <div className="login-brand">
                  <div className="logo-mark bigger">
                      <div className="logo-inner"></div>
                  </div>
                  <h1 className="brand-name">VoteSense <span className="ai-tag">AI</span></h1>
              </div>
              <div className="login-card glass">
                  <div className="badge tricolour">Personalize Your Journey</div>
                  <h2>Welcome, <br/><span className="gradient-text">Future Voter</span></h2>
                  <p>Your personalized AI companion is ready. Enter your name to begin the cinematic journey.</p>
                  <form className="login-input-group" onSubmit={handleLogin}>
                      ...
                      <button type="button" className="btn-secondary btn-google" onClick={handleGoogleLogin}>
                          <span className="icon" aria-hidden="true">G</span> Continue with Google (Simulated)
                      </button>
                  </form>
              </div>
          </div>
            ...
            <section id="landing-story" className="cinematic-track">
                <div id="cinematic-canvas" className="canvas-pinned">
                    ...
                    <div className="layers-container">
                        ...
                        {/* Layer 1: Hero */}
                        <article id="layer-hero" className="layer active">
                            <div className="content-box left">
                                <div className="badge tricolour" aria-hidden="true">AI Election Guide</div>
                                <h1 className="hero-title">Your Vote is Your <br/><span className="gradient-text">Greatest Power.</span></h1>
                                <p className="hero-desc">Confusion shouldn't be a barrier to your rights. Use VoteSense AI to simplify your journey from registration to the polling booth.</p>
                                <div className="hero-actions">
                                    <button className="btn-scroll" onClick={() => gsap.to(window, { scrollTo: "#layer-problem", duration: 1.5, ease: "power2.inOut" })}>Scroll to Explore <span className="mouse-icon"></span></button>
                                </div>
                            </div>
                            <div className="content-box right hero-visuals" aria-hidden="true">
                                <div className="floating-data-card glass">
                                    <span className="card-icon">📍</span>
                                    <div className="card-info">
                                        <span className="label">Booth Finder</span>
                                        <span className="value">Live Tracking</span>
                                    </div>
                                </div>
                                <div className="floating-data-card glass">
                                    <span className="card-icon">🪪</span>
                                    <div className="card-info">
                                        ...
                                        <span className="value">Status: Verified</span>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        {/* Layer 2: The Problem */}
                        <article id="layer-problem" className="layer">
                            <div className="content-box center">
                                <h2 className="layer-title">The "Voter's Gap"</h2>
                                <p className="layer-subtitle">Common hurdles that prevent potential votes from being cast.</p>
                                <div className="problem-grid" role="list">
                                    <div className="p-card glass integrated" role="listitem">
                                        <div className="p-icon" aria-hidden="true">📄</div>
                                        <h3>Registration</h3>
                                        <p>Complex forms and strict deadlines leading to unexpected rejections.</p>
                                    </div>
                                    <div className="p-card glass integrated" role="listitem">
                                        <div className="p-icon" aria-hidden="true">🔍</div>
                                        <h3>Verification</h3>
                                        <p>Discovering names missing from the electoral roll at the last moment.</p>
                                    </div>
                                    <div className="p-card glass integrated" role="listitem">
                                        <div className="p-icon" aria-hidden="true">🚉</div>
                                        <h3>Logistics</h3>
                                        <p>Uncertainty about designated polling booths or required documentation.</p>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        <article id="layer-solution" className="layer">
                            <div className="split-content">
                                <div className="content-box left">
                                    <div className="badge tricolour" aria-hidden="true">The Solution</div>
                                    <h2 className="layer-title">The VoteSense <br/><span className="gradient-text">Path</span></h2>
                                    <p className="layer-subtitle">A clear, step-by-step roadmap to ensuring your voice is heard.</p>
                                </div>
                                <div className="solution-timeline" role="list">
                                    <div className="s-step" role="listitem">
                                        <div className="s-dot" aria-hidden="true">1</div>
                                        <div className="s-text">Digital Profiling</div>
                                    </div>
                                    <div className="s-step" role="listitem">
                                        <div className="s-dot" aria-hidden="true">2</div>
                                        <div className="s-text">Gap Analysis</div>
                                    </div>
                                    <div className="s-step" role="listitem">
                                        <div className="s-dot" aria-hidden="true">3</div>
                                        <div className="s-text">Action Roadmap</div>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        {/* Layer 4: Final CTA */}
                        <article id="layer-cta" className="layer">
                            <div className="content-box center">
                                <h2 className="layer-title gradient-text">Check Your Readiness</h2>
                                <p className="layer-subtitle">Take a quick assessment to see if you're prepared for the next election.</p>
                                <button id="btn-start-check" className="btn-primary-large" onClick={() => navigate('/onboarding')}>
                                    Start Readiness Check <span className="arrow">→</span>
                                </button>
                            </div>
                        </article>
